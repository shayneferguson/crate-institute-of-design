...
* An unusual record sleeve  
* A transit map  
* A type specimen  
* A skateboard graphic  
...
The goal is to preserve evidence before interpretation begins.  
...
Synthesis transforms information into understanding.  
  
⸻  
  
**Research Formats**  
  
The Institute utilizes four primary forms of research.  
...
Whenever possible, findings should be supported through documented sources.  
...
The Crate Institute of Design views research as a continuous process of discovery.  
  
The world contains more information than any archive can hold.  
