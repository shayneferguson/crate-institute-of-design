...
The Crate Institute of Design is an independent institution dedicated to the collection, study, preservation, documentation, and exploration of design.  
  
The Institute exists to investigate the artifacts, systems, ideas, methods, and histories that shape the designed world.  
  
It operates as a living archive.  
...
The Institute approaches design through a methodology of creative archaeology.  
...
Research findings, observations, methodologies, and collected materials are systematically recorded in order to support future inquiry.  
...
The Institute exists, in part, to resist that loss.  
